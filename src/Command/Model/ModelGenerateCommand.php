 ...
 */
class ModelGenerateCommand extends AbstractCodeGenerationCommand
{

    protected function initializeTableBasedCodeGenerators(): array
    {
        return [
            (app()->make(ModelClassGenerator::class)),
            (app()->make(ModelAbstractClassGenerator::class)),
        ];
    }

    protected function getCommandName(): string
    {
        return "reliese:generate:models";
    }

    protected function getCommandDescription(): string
    {
        return "Generates Model class definitions";
    }
//    /**
